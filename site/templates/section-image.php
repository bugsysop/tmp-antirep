...
<div class="site-wrapper"><!-- site-wrapper -->
    ...
    <?php if ($articles = $page->children()->visible()->paginate(10)): // pagination ?>
        ...
        <nav class="pagination" role="navigation">
            <a class="newer-posts" href="<?php echo $articles->pagination()->prevPageURL() ?>">&lsaquo;&lsaquo;Newer posts</a>
            </nav>
        <?php endif ?>
        <?php if ($articles->pagination()->hasNextPage()): ?>
            <nav class="pagination" role="navigation">
            <a class="older-posts" href="<?php echo $articles->pagination()->nextPageURL() ?>">Older posts &rsaquo;&rsaquo;</a>
            </nav>
        <?php endif ?>
        </nav>
    <?php endif ?>
